...
class RancherNamespace {
     ...
     */
    isNamespaceExistOnProject(clusterID, projectID, namespace) {
     ...
     */
    moveNamespace(clusterID, namespace, newProjectID) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
...
exports.RancherNamespace = RancherNamespace;
...
class RancherProject {
     ...
     */
    isProjectExist(clusterID, projectName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
...
exports.RancherProject = RancherProject;
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const [projectExist, projectID] = yield projectObj.isProjectExist(clusterID, projectName);
            let usableProjectID = projectID;
            if (projectExist) {
                core.info(`Project ${projectName} is already exist`);
            }
            else {
                usableProjectID = yield projectObj.createProject(clusterID, projectName);
